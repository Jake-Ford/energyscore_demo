...
with st.spinner("Loading map..."):
    ...
    state_name = st.sidebar.selectbox("Select State", ["New Mexico", "Massachusetts"])
    ...
    zip_state_filtered = zip_level_geo[zip_level_geo['state'] == state_name]

    # Display the top 10 ZIP codes with Qualification Increase < 100
    top_zip_codes = zip_state_filtered[zip_state_filtered['Qualification Increase'] < 100].nlargest(10, 'Qualification Increase')
    st.write("Top Qualification Increase ZIP Codes")
    st.dataframe(top_zip_codes[['ZIP', 'Qualification Increase']])
